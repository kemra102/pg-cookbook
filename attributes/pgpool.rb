...
default['pg']['config']['pgpool']['memqcache_memcached_port'] = 11211
default['pg']['config']['pgpool']['memqcache_total_size'] = 67108864
default['pg']['config']['pgpool']['memqcache_max_num_cache'] = 1000000
default['pg']['config']['pgpool']['memqcache_expire'] = 0
default['pg']['config']['pgpool']['memqcache_auto_cache_invalidation'] = true
default['pg']['config']['pgpool']['memqcache_maxcache'] = 409600
default['pg']['config']['pgpool']['memqcache_cache_block_size'] = 1048576
